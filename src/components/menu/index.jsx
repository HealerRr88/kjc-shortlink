...
export default function Menu({ logedInUser }) {
  const navigate = useNavigate();

  const logout = () => {
    localStorage.removeItem(TOKEN_NAME);
    localStorage.removeItem(RR88_SHORTLINK_USER);
    setAuthorization('');
    navigate("/login");
  }
      ...
      <Accordion defaultActiveKey="0">
        <Accordion.Item className="border-0" eventKey="0">
          <Accordion.Header>
            ...
            <span className="fw-bold ms-2">Trang chủ</span>
          </Accordion.Header>
          <Accordion.Body>
            <NavLink to='/' className={({ isActive }) => (isActive ? "text-decoration-none text-secondary fw-bold active" : "text-decoration-none text-secondary fw-bold")}>
        ...
        <Accordion.Item className="border-0" eventKey="1">
          <Accordion.Header>
            ...
            <span className="fw-bold ms-2">Shortlinks</span>
          </Accordion.Header>
          <Accordion.Body>
            <div>
              <NavLink to='/links' className={({ isActive }) => (isActive ? "text-decoration-none text-secondary fw-bold active" : "text-decoration-none text-secondary fw-bold")}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-share" viewBox="0 0 16 16">
                  <path d="M13.5 1a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3M11 2.5a2.5 2.5 0 1 1 .603 1.628l-6.718 3.12a2.5 2.5 0 0 1 0 1.504l6.718 3.12a2.5 2.5 0 1 1-.488.876l-6.718-3.12a2.5 2.5 0 1 1 0-3.256l6.718-3.12A2.5 2.5 0 0 1 11 2.5m-8.5 4a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3m11 5.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3" />
                </svg>
                <span className="ms-2">Quản lý shortlinks</span>
              </NavLink>
            </div>
          </Accordion.Body>
        </Accordion.Item >
          ...
          logedInUser?.role.rolename === 'Admin' && (
            <Accordion.Item className="border-0" eventKey="2">
              <Accordion.Header>
                ...
                <span className="fw-bold ms-2">Logs</span>
              </Accordion.Header>
              <Accordion.Body>
                <div className="mb-3">
                  <NavLink to='/logs' className={({ isActive }) => (isActive ? "text-decoration-none text-secondary fw-bold active" : "text-decoration-none text-secondary fw-bold")}>
                    ...
                    <span className="ms-2">Quản lý logs</span>
                  </NavLink>
                </div>
              </Accordion.Body>
            </Accordion.Item >
        ...
        <Accordion.Item className="border-0" eventKey="3">
          <Accordion.Header>
            ...
            <span className="fw-bold ms-2">Tài khoản</span>
          </Accordion.Header>
          <Accordion.Body>
            {
              logedInUser?.role.rolename === 'Admin' ? (
                <>
                  <div className="mb-3">
                    <NavLink to='/users' className={({ isActive }) => (isActive ? "text-decoration-none text-secondary fw-bold active" : "text-decoration-none text-secondary fw-bold")}>
                  ...
                  <div className="mb-3">
                    <NavLink to='/roles' className={({ isActive }) => (isActive ? "d-block text-decoration-none text-secondary fw-bold active" : "d-block text-decoration-none text-secondary fw-bold mt-3")}>
                      ...
                      <span className="ms-2">Quản lý vai trò</span>
                    </NavLink>
                  </div>
                </>
              ) : (
                <div className="mb-3">
                  <NavLink to='/profile' className={({ isActive }) => (isActive ? "text-decoration-none text-secondary fw-bold active" : "text-decoration-none text-secondary fw-bold")}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-gear" viewBox="0 0 16 16">
                      <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0M8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m.256 7a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10q.39 0 .74.025c.226-.341.496-.65.804-.918Q8.844 9.002 8 9c-5 0-6 3-6 4s1 1 1 1zm3.63-4.54c.18-.613 1.048-.613 1.229 0l.043.148a.64.64 0 0 0 .921.382l.136-.074c.561-.306 1.175.308.87.869l-.075.136a.64.64 0 0 0 .382.92l.149.045c.612.18.612 1.048 0 1.229l-.15.043a.64.64 0 0 0-.38.921l.074.136c.305.561-.309 1.175-.87.87l-.136-.075a.64.64 0 0 0-.92.382l-.045.149c-.18.612-1.048.612-1.229 0l-.043-.15a.64.64 0 0 0-.921-.38l-.136.074c-.561.305-1.175-.309-.87-.87l.075-.136a.64.64 0 0 0-.382-.92l-.148-.045c-.613-.18-.613-1.048 0-1.229l.148-.043a.64.64 0 0 0 .382-.921l-.074-.136c-.306-.561.308-1.175.869-.87l.136.075a.64.64 0 0 0 .92-.382zM14 12.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0" />
                    </svg>
            ...
            <div className="cursor-pointer text-danger" onClick={() => { logout() }}>
